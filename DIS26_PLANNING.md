...
> 통합 신규 인터페이스(Orchestration)·Agentic AI를 만드는 입장에서, **(Ⅰ) 통합/에이전트 인터페이스 디자인 · (Ⅱ) Agentic 금융서비스의 고객 행동 · (Ⅲ) 인터페이스로 사기·기만 방어 · (Ⅳ) 현장조사 없이 고객을 이해하는 AI 페르소나** 4갈래로 DIS 논문을 재정리한다.
...
### Ⅲ. 인터페이스 디자인으로 사기·기만(deception/fraud) 방어
...
### Ⅳ. 현장조사 없이 고객을 이해하는 AI 페르소나 (synthetic personas)
*실사용자 리크루팅 없이 LLM 페르소나로 고객을 모사·인터뷰·평가*
...
> "한국대학교(고려대)" 단독 발표는 없음. 추천 15편 중 한국 소속 + 그 외 주요 한국 발표.
