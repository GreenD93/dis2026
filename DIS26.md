...
## 2. 요일별 추천 일정 (세션 · 장소 · 시간)

> 같은 세션(시간·장소)에 여러 추천 논문이 묶이면 한 자리에서 연속 관람. 주제: 🧩 통합·Orchestration · 🎭 AI 페르소나 · 💰 금융 고객행동 · 🛡 사기·기만 방어

### 📅 6/15(월)

**🕘 11:00–12:30 · AI-Augmented Creative Interfaces · 📍 LT 50 (Stephen Riady Centre Lv1)**
...
**🕘 11:00–12:30 · LLMs for Learning and Neurodiversity · 📍 LT 52 (Stephen Riady Centre Lv2)**
...
**🕘 09:00–10:30 · Power, Privacy, and Participation · 📍 Auditorium 2 (Stephen Riady Centre Lv1)**
...
- **Ⅰ. 통합 신규 인터페이스 · Orchestration · Agentic AI** — DIS01, DIS02, DIS03, DIS04, DIS05
- **Ⅱ. AI 페르소나 — 정체성 설계 + 합성 페르소나(고객 이해)** — DIS16, DIS17, DIS12, DIS13, DIS14, DIS15
- **Ⅲ. Agentic AI 금융 서비스에서의 고객 행동** — DIS06, DIS07, DIS08
- **Ⅳ. 인터페이스 디자인으로 사기·기만(deception/fraud) 방어** — DIS09, DIS10, DIS11
